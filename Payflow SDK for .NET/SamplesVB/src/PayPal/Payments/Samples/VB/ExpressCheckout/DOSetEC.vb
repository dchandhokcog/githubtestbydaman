        ...
        Public Shared Sub Main(ByVal Args As String())
            ...
            If Not Resp Is Nothing Then
                ...
                If TrxnResponse.Result = 0 Then
                    ...
                    'Dim PayPalUrl As String = "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token="

                    ' For Express Checkout Reference Transaction without Purchase. 
                    Dim PayPalUrl As String = "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_customer-billing-agreement&token="
