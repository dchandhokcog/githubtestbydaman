    ...
    Public Class NVPCommandLine
        ...
        Public Shared Sub Main(ByVal Args As String())
            ...
            If Args.Length < 4 Then
                ...
                Console.WriteLine(Environment.NewLine + "Example transaction:" + Environment.NewLine + "SamplesVB pilot-payflowpro.paypal.com 443 ""USER=<user>&TRXTYPE[1]=A&VENDOR=<vendor>&AMT[5]=25.00&PWD=<password>&PARTNER=<partner>&TENDER[1]=C&ACCT[16]=5100000000000008&EXPDATE[4]=0110"" 45")
