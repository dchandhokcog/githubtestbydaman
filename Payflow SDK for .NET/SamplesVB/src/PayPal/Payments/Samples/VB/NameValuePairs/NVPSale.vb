...
Namespace PayPal.Payments.Samples.VB.NameValuePairs
    ...
    Public Class NVPSale
        ...
        Public Shared Sub Main(ByVal Args As String())
            ...
            Dim Request As String = "TRXTYPE=S&ACCT=5105105105105100&EXPDATE=0112&TENDER=C&INVNUM=INV12345&AMT=25.12&PONUM=PO12345&STREET=123 Main St.&ZIP=12345&USER=<user>&VENDOR=<vendor>&PARTNER=<partner>&PWD=<password>"
