...
namespace PayPal.Payments.Samples.CS.NameValuePairs
{
	...
	public class NVPSale
	{
		...
		public static void Main(string[] Args)
		{
			...
			String Request = "TRXTYPE=S&ACCT=5105105105105100&EXPDATE=0109&TENDER=C&INVNUM=INV12345&AMT=25.12&PONUM=PO12345&STREET=123 Main St.&ZIP=12345&USER=<user>&VENDOR=<vendor>&PARTNER=<partner>&PWD=<password>";
