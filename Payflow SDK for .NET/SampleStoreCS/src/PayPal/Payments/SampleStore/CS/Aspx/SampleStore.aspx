<%@ Page language="c#" Codebehind="SampleStore.aspx.cs" AutoEventWireup="false" Inherits="PayPal.Payments.SampleStore.CS.Aspx.SampleStore" %>
<!DOCTYPE html
PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML lang="EN">
	<HEAD>
		<title>PayPal .NET SDK C# Sample Store</title>
		...
		<form id="frmSampleStore" method="post" runat="server">
			<table id="TblHeading" cellspacing="1" cellpadding="1" width="100%">
				<tr>
					<th valign="middle" align="center" class="heading">
						PayPal .NET SDK C# Sample Store</th>
					<td align="right">
			...
			<asp:Panel id="PnlSampleStoreForm" runat="server">
				...
				<TABLE class="table" id="TblRequestGrid" cellSpacing="1" cellPadding="1" width="100%" border="0">
					...
					<TR>
						<TD align="left">
							<asp:label id="LblRequestId" runat="server">PAYFLOW-Request-ID</asp:label></TD>
...
-->
					...
					<TR>
						<TD align="left">
							<asp:label id="LblOrderDate" runat="server">ORDERDATE(YYYYMMDD)<br /></asp:label></TD>
						<TD align="left" colSpan="1" rowSpan="1">
							<asp:textbox id="TxtBoxOrderDate" runat="server" MaxLength="80"></asp:textbox></TD>
					</TR>
					<TR>
						<TD align="left">
							<asp:label id="LblOrderTime" runat="server">ORDERTIME(YYYYMMDDhhmmss)</asp:label></TD>
						<TD align="left" colSpan="1" rowSpan="1">
							<asp:textbox id="TxtBoxOrderTime" runat="server" MaxLength="80"></asp:textbox></TD>
					</TR>
					<TR>
						<TD align="left">
							...
							<asp:datagrid id="RecurringDataGrid" runat="server" AutoGenerateColumns="false">
								<Columns>
									<asp:TemplateColumn HeaderStyle-Width="200" HeaderStyle-Font-Bold="True" HeaderText="Recurring Response Field">
										<ItemTemplate>
											<asp:label ID="LblRecurringKey" Runat="server" text='' />
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Font-Bold="True" HeaderText="Recurring Response Value">
										<ItemTemplate>
											<asp:label ID="LblRecurringValue" Runat="server" text='' />
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
							</asp:datagrid>
							...
							<asp:datagrid id="FraudDataGrid" runat="server" AutoGenerateColumns="false">
								<Columns>
									<asp:TemplateColumn HeaderStyle-Width="200" HeaderStyle-Font-Bold="True" HeaderText="Fraud Response Field">
										<ItemTemplate>
											<asp:label ID="LblFraudKey" Runat="server" text='' />
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderStyle-Font-Bold="True" HeaderText="Fraud Response Value">
										<ItemTemplate>
											<asp:label ID="LblFraudValue" Runat="server" text='' />
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
							</asp:datagrid></TD>
