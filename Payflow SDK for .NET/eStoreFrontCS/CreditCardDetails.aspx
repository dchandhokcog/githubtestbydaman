<%@ Page language="c#" Codebehind="CreditCardDetails.aspx.cs" AutoEventWireup="false" Inherits="eStoreFrontCS.CreditCardDetails" %>
  ...
  <HEAD>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="lblSTState" style="Z-INDEX: 140; LEFT: 48px; POSITION: absolute; TOP: 648px"
			...
			<asp:Label id="lblSTZip" style="Z-INDEX: 139; LEFT: 248px; POSITION: absolute; TOP: 640px"
				runat="server" Font-Size="X-Small" Font-Names="Verdana" Height="16px" Width="24px">Zip</asp:Label>
			<asp:Label id="lblSTCity" style="Z-INDEX: 138; LEFT: 48px; POSITION: absolute; TOP: 616px"
				runat="server" Font-Size="X-Small" Font-Names="Verdana" Height="16px" Width="87px">City</asp:Label>
			<asp:TextBox id="txtShipToState" style="Z-INDEX: 137; LEFT: 176px; POSITION: absolute; TOP: 640px"
				runat="server" Width="32px" Height="24px" Font-Names="Verdana" MaxLength="2" tabIndex="17"></asp:TextBox>
			<asp:TextBox id="txtShipToZip" style="Z-INDEX: 136; LEFT: 296px; POSITION: absolute; TOP: 640px"
				runat="server" Width="48px" Height="24px" Font-Names="Verdana" MaxLength="5" tabIndex="18"></asp:TextBox>
			<asp:TextBox id="txtShipToCity" style="Z-INDEX: 135; LEFT: 176px; POSITION: absolute; TOP: 608px"
				runat="server" Width="168px" Height="24px" Font-Names="Verdana" tabIndex="16"></asp:TextBox>
			<asp:TextBox id="txtShipToStreet" style="Z-INDEX: 134; LEFT: 176px; POSITION: absolute; TOP: 576px"
				runat="server" Width="168px" Height="24px" Font-Names="Verdana" tabIndex="15"></asp:TextBox>
			<asp:Label id="lblSTStreet" style="Z-INDEX: 133; LEFT: 48px; POSITION: absolute; TOP: 584px"
				runat="server" Width="48px" Height="16px" Font-Names="Verdana" Font-Size="X-Small">Street</asp:Label>
			<asp:TextBox id="txtShipToLName" style="Z-INDEX: 132; LEFT: 440px; POSITION: absolute; TOP: 544px"
				runat="server" Width="162px" Height="24px" Font-Names="Verdana" tabIndex="14"></asp:TextBox>
			<asp:Label id="lblSTLName" style="Z-INDEX: 131; LEFT: 392px; POSITION: absolute; TOP: 544px"
				runat="server" Width="42px" Height="16px" Font-Names="Verdana" Font-Size="X-Small">Last</asp:Label>
			<asp:TextBox id="txtShipToFName" style="Z-INDEX: 130; LEFT: 176px; POSITION: absolute; TOP: 544px"
				runat="server" Width="170px" Height="24px" Font-Names="Verdana" tabIndex="13"></asp:TextBox>
			<asp:Label id="lblSTFName" style="Z-INDEX: 129; LEFT: 128px; POSITION: absolute; TOP: 544px"
				runat="server" Width="42px" Height="16px" Font-Names="Verdana" Font-Size="X-Small">First</asp:Label>
			<asp:Label id="lblSTName" style="Z-INDEX: 128; LEFT: 48px; POSITION: absolute; TOP: 544px"
				runat="server" Width="42px" Height="16px" Font-Names="Verdana" Font-Size="X-Small">Name</asp:Label>
			<asp:Label id="lblShippingAddress" style="Z-INDEX: 126; LEFT: 48px; POSITION: absolute; TOP: 456px"
			...
			<DIV style="DISPLAY: inline; FONT-WEIGHT: normal; FONT-SIZE: medium; Z-INDEX: 101; LEFT: 32px; WIDTH: 360px; BORDER-TOP-STYLE: none; FONT-FAMILY: Verdana; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; POSITION: absolute; TOP: 16px; HEIGHT: 24px; BORDER-BOTTOM-STYLE: none"
				align="left" ms_positioning="FlowLayout">Billing and Shipping Information</DIV>
			<asp:Label id="lblCCNumber" style="Z-INDEX: 102; LEFT: 40px; POSITION: absolute; TOP: 128px"
			...
			<HR style="Z-INDEX: 124; LEFT: 24px; POSITION: absolute; TOP: 432px" align="left" width="92%"
				SIZE="8" color="#146690">
			<HR style="Z-INDEX: 125; LEFT: 32px; POSITION: absolute; TOP: 200px" align="left" width="92%"
				SIZE="8" color="#146690">
			<asp:CheckBox id="chkCopyBilling" style="Z-INDEX: 127; LEFT: 48px; POSITION: absolute; TOP: 496px"
			...
			<asp:Button id="btnCheckout" style="Z-INDEX: 141; LEFT: 32px; POSITION: absolute; TOP: 736px"
				runat="server" Width="106px" Height="27px" Text="Checkout" Font-Names="Verdana" tabIndex="19"></asp:Button>
			<HR style="Z-INDEX: 142; LEFT: 25px; POSITION: absolute; TOP: 712px; BACKGROUND-COLOR: blue"
				align="left" width="92%" SIZE="8" color="#146690">
			<HR style="Z-INDEX: 143; LEFT: 32px; POSITION: absolute; TOP: 48px" align="left" width="92%"
				color="#146690" SIZE="8">
			<asp:CheckBox id="chkProcessWithBuyerAuth" style="Z-INDEX: 144; LEFT: 421px; POSITION: absolute; TOP: 155px"
				tabIndex="5" runat="server" Width="412px" Height="10px" Font-Names="Verdana" Font-Size="X-Small"
				Text="Process purchase using Buyer Authentication"></asp:CheckBox>
			<asp:Label id="Label1" style="Z-INDEX: 147; LEFT: 440px; POSITION: absolute; TOP: 177px" runat="server"
